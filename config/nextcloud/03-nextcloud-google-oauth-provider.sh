...
echo
echo "🔐 Homelab v2.4.3 - Nextcloud Google Social Login Provider"
echo
...
echo
echo "📋 Kontrol:"
occ config:app:get sociallogin custom_providers >/dev/null 2>&1 && echo "✅ Social Login provider mevcut (secret redacted)." || true
