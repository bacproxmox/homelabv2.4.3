# Homelab v2.4.3 Stabilization Notes

v2.4.3 keeps the v2.4 architecture and focuses on reducing mid-install prompts, tightening health checks, and polishing services found during the v2.4 fresh install test.
...
- Support bundle copy helper belongs to v2.4.3 maintenance menu.
